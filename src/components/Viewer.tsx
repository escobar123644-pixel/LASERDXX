  ...
  return (
    <div className="relative w-full h-full bg-slate-950 overflow-hidden select-none">
      <div className="absolute top-4 right-4 flex flex-col gap-2 z-10">
        ...
        <button type="button" onClick={fitScreen} className="p-2 bg-slate-800 text-emerald-400 rounded hover:bg-slate-700 border border-slate-700 shadow"><Maximize size={20} /></button>
      </div>
